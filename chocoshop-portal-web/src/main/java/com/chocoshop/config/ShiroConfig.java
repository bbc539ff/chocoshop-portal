...
import com.chocoshop.realm.UserLoginRealm;
...
//        filterChainDefinitionMap.put("/user/logout", "logout");
        filterChainDefinitionMap.put("/user/order/**", "authc");
        filterChainDefinitionMap.put("/user/user-info", "authc");
